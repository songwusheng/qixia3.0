...
/**
 * If there is no bug, then it is created by ChenFengYao on 2017/home_bg_icon4/19,
...
public class InstallUtil {
    ...
    private static void installNormal(Context context, String apkPath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri apkUri = FileProvider.getUriForFile(context, "com.heziz.qixia3.fileProvider", file);
